...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Nome do serviço', example: 'Corte de cabelo' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Preço do serviço', example: 50.0, minimum: 0 }),
