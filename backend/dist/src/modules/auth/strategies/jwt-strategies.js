...
let JwtStrategy = JwtStrategy_1 = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'jwt') {
    ...
    constructor(prisma, configService) {
        ...
        this.logger.log(`JwtStrategy inicializada com secret: ${configService.get('JWT_SECRET') ? 'configurado' : 'usando default'}`);
    }
    async validate(payload) {
        ...
        try {
            ...
            this.logger.error(`Erro na validação do JWT: ${error.message}`);
            throw error;
        }
    }
};
