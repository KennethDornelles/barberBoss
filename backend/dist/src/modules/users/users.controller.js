...
let UsersController = class UsersController {
    ...
    async findAll(req, limit, offset, role) {
    ...
    async create(dto) {
        if (dto.role && dto.role !== 'CLIENT') {
            throw new common_1.NotFoundException('Barbeiro só pode criar clientes');
        }
        dto.role = 'CLIENT';
    ...
    async update(id, dto) {
        if (dto.role && dto.role !== 'CLIENT') {
            throw new common_1.NotFoundException('Barbeiro só pode atualizar clientes');
        }
    ...
    async remove(id) {
        ...
        if (!user || user.role !== 'CLIENT') {
            throw new common_1.NotFoundException('Barbeiro só pode deletar clientes');
        }
